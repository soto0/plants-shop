...
import OfferIcon2 from './../../../assets/images/offer__icon2.png';
        ...
        <div className={s.offer}>
            <div className={s.offer__banner}>
                ...
                <div className={s.offer__banner_right}>
                    ...
                    <NavLink to='' className="button banner__button">
                        Find More
                        <img src={OfferArrow} alt="offer__arrow" />
                    </NavLink>
                </div>
            </div>
            <div className={s.offer__banner}>
                <div className={s.offer__banner_left}>
                    <img src={OfferIcon2} alt="banner_icon" className={s.banner__icon} />
                </div>
                <div className={s.offer__banner_right}>
